...
public class ScijavaCommandCheckCapitalLetters {
    ...
    private static boolean containsACapitalLetter(String str) {
        ...
        for(int i=0;i < str.length();i++) {
            ...
            /*if(numberFlag && capitalFlag && lowerCaseFlag)
                return true;*/
            if (capitalFlag) return capitalFlag;
        }
        return false;
    }
    ...
    public static String warnAboutCapitalLetter(Class<? extends Command> c, Map<Class<?>, String> providedByPython) {
        StringBuilder builder = new StringBuilder();
        Plugin plugin = c.getAnnotation(Plugin.class);
        if (plugin!=null) {
            //String url = linkGitHubRepoPrefix+c.getName().replaceAll("\\.","\\/")+".java";
    ...
    public static void main(String... args) {
        ...
        // ch.epfl.biop.scijava.command.source.register
        reflections = new Reflections("ch.epfl.biop.scijava.command.source.register");
        reflections = new Reflections("ch.epfl.biop.scijava.command.source");
        reflections = new Reflections("ch.epfl.biop");//.epfl.biop.scijava.command");
        ...
        commandClasses.forEach(c -> methodPerClass.put(c.getSimpleName(), warnAboutCapitalLetter(c, providedByPython)));
