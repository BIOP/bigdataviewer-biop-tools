 ...
 *
 * <p>This task shares {@link ApposeElastixTask}'s warm worker pool, so it also benefits from
 * (and triggers, on first use) the same one-off environment build and its progress dialog.</p>
 */
