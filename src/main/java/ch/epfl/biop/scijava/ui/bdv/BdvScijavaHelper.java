package ch.epfl.biop.scijava.ui.bdv;

import bdv.util.BdvHandle;
import bdv.util.BdvHandleFrame;
import ch.epfl.biop.scijava.command.OpenImarisCommand;
...
public class BdvScijavaHelper {
    ...
    public static void main(String... args) throws Exception {
        ...
        ij.ui().showUI();
        BdvHandle bdvh = (BdvHandle) ij.command().run(BdvWindowCreatorCommand.class, true).get().getOutput("bdvh");
