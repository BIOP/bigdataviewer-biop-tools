...
public class SourceVirtualStack<T extends NumericType<T> & NativeType<T>> extends VirtualStack {

    private static final Logger logger = LoggerFactory.getLogger(SourceVirtualStack.class);
     ...
     */
    public SourceVirtualStack(List<SourceAndConverter<T>> sources,
                              int resolutionLevel,
                              CZTRange range,
