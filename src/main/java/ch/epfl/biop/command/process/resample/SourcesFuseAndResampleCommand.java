...
@Plugin(type = BdvPlaygroundActionCommand.class,
        menuPath = BdvPgMenus.RootMenu+"Process>Fuse & Resample>Source - Fuse And Resample Sources",
        description = "Fuses multiple sources into one, resampled to match a model source's grid")
public class SourcesFuseAndResampleCommand implements BdvPlaygroundActionCommand {
