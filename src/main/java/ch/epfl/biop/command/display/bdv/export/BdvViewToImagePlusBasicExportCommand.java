package ch.epfl.biop.command.display.bdv.export;
...
import static bdv.util.ZSlicedSource.getNormTransform;
...
public class BdvViewToImagePlusBasicExportCommand<T extends RealType<T>> implements BdvPlaygroundActionCommand {

    private static Logger logger = LoggerFactory.getLogger(BdvViewToImagePlusBasicExportCommand.class);
    ...
    public void matchXYBDVFrame() {
        ...
        this.xSize= ch.epfl.biop.command.display.bdv.export.BdvViewToImagePlusExportCommand.distance(ptTopLeft, ptTopRight);
        this.ySize= ch.epfl.biop.command.display.bdv.export.BdvViewToImagePlusExportCommand.distance(ptTopLeft, ptBottomLeft);
    }
