...
public class BdvViewToSourcesExportCommand implements BdvPlaygroundActionCommand {

    private static Logger logger = LoggerFactory.getLogger(BdvViewToSourcesExportCommand.class);
