...
@Plugin(type = BdvPlaygroundActionCommand.class,
        //menuPath = BdvPgMenus.RootMenu+"View>BDV>ROI>BDV - Define Points",
        menu = {
                ...
                @Menu(label = "BDV - Define Points", weight = 2)
        },
        description = "Allows the user to interactively select multiple points in a BigDataViewer window")
public class UserPointsGetCommand implements BdvPlaygroundActionCommand {
    ...
    public static void main(String... args) throws Exception {
        ...
        ij.command().run(UserPointsGetCommand.class, true,
                "bdvh", bdvh,
                "time_out_in_ms", -1,
