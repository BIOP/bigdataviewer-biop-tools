...
@Plugin(type = BdvPlaygroundActionCommand.class,
        //menuPath = BdvPgMenus.RootMenu +"Export>Source - Slice Current BDV Sources",
        menu = {
                ...
                @Menu(label = "BDV - Export Current View As Sources", weight = 6)
        },
        description = "Resamples sources to an arbitrary oblique slice based on the current BDV view orientation")
public class BdvViewToSourceCommand implements BdvPlaygroundActionCommand {

    private static Logger logger = LoggerFactory.getLogger(BdvViewToSourceCommand.class);
    ...
    public boolean reuse_mipmaps = true;
