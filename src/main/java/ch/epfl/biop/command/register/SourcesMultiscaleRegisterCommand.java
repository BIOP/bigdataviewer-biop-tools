...
public class SourcesMultiscaleRegisterCommand implements BdvPlaygroundActionCommand{

    private static Logger logger = LoggerFactory.getLogger(SourcesMultiscaleRegisterCommand.class);
            ...
            for (int scale = 0; scale<nScales; scale++) {
                ...
                RealTransform currentLevelTransform =
                        (RealTransform) cs.run(Elastix2DSparsePointsRegisterCommand.class, true,
                                ...
                                "px_size_in_current_unit", pixelSizeBlockmm,
                                "interpolate", true,
                                "show_points", show_details,
