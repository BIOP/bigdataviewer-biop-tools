package ch.epfl.biop.command.register.warpy.wizard;
...
import static ch.epfl.biop.command.register.warpy.wizard.WarpyEditRegistrationCommand.removeZOffsets;

@Plugin(type = BdvPlaygroundActionCommand.class,
        //menuPath = BdvPgMenus.RootMenu+"Register>Warpy (Wizard)>Warpy - Export Registered Image",
        menu = {
                @Menu(label = BdvPgMenus.L1),
                @Menu(label = BdvPgMenus.L2),
                @Menu(label = BdvPgMenus.RegisterMenu, weight = BdvPgMenus.RegisterW),
                @Menu(label = "Warpy (Wizard)", weight = -1),
