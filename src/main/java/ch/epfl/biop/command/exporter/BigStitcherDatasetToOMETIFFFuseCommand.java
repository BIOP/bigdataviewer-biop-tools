...
@Plugin(type = BdvPlaygroundActionCommand.class,
        ...
        menu = {
                ...
                @Menu(label = "Dataset - Fuse BigStitcher Dataset To OME-TIFF", weight = 6)
        },
        description = "Fuses a BigStitcher dataset and exports it as a pyramidal OME-TIFF file")
public class BigStitcherDatasetToOMETIFFFuseCommand implements BdvPlaygroundActionCommand {
    ...
    public void run() {
        ...
        AbstractSpimData asd = new XMLToDatasetImporter(xml_bigstitcher_file).get();
