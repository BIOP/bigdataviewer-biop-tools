package ch.epfl.biop.command.bdv.region;
...
@Plugin(type = BdvPlaygroundActionCommand.class,
        menuPath = ScijavaBdvDefaults.RootMenu+"Viewers>BDV>BDV>ROI>BDV - Define Rectangle",
        description = "Allows the user to interactively select a rectangle in a BigDataViewer window")
public class GetUserRectangleCommand implements BdvPlaygroundActionCommand {
