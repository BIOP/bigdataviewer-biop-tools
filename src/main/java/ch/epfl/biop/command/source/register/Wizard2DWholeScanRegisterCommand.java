...
import ch.epfl.biop.command.bdv.region.GetUserPointsCommand;
import ch.epfl.biop.command.bdv.region.GetUserRectangleCommand;
...
import ch.epfl.biop.viewers.bdv.PointsSelectorOverlay;
import ij.IJ;
...
import static ch.epfl.biop.command.source.transform.RemoveZOffsetCommand.getZ0Transform;
