...
public class EllipticalTransformSource <T> implements Source< T >, MipmapOrdering
{
    ...
    public static < T > SourceAndConverter< T > wrap( final SourceAndConverter< T > wrap, final String name, int ndims )
    {
        return new SourceAndConverter< T >(
                new EllipticalTransformSource< T >( wrap.getSpimSource(), name ),
                wrap.getConverter(),
    ...
    public EllipticalTransformSource( final Source< T > source, final String name )
    {
        this.source = source;
        this.name = name;
