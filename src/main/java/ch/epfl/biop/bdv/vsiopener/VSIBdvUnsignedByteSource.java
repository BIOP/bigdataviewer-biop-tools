...
public class VSIBdvUnsignedByteSource extends VSIBdvSource<UnsignedByteType> {
    public VSIBdvUnsignedByteSource(ImageReader reader, int image_index, int channel_index, boolean sw) {
