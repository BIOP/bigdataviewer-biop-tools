 ...
 */
public abstract class VirtualStackImageLoaderTimeShifted< T extends NativeType< T >, V extends Volatile< T > & NativeType< V >, A extends VolatileAccess >
        implements ViewerImgLoader, TypedBasicImgLoader< T >
{
    public static VirtualStackImageLoaderTimeShifted< FloatType, VolatileFloatType, VolatileFloatArray > createFloatInstance( final ImagePlus imp, int timeShift )
    {
        return new VirtualStackImageLoaderTimeShifted< FloatType, VolatileFloatType, VolatileFloatArray >(
                imp, new VirtualStackVolatileFloatArrayLoader( imp ), new FloatType(), new VolatileFloatType(), timeShift )
        {
            @Override
    ...
    public static VirtualStackImageLoaderTimeShifted< UnsignedShortType, VolatileUnsignedShortType, VolatileShortArray > createUnsignedShortInstance( final ImagePlus imp, int timeShift )
    {
        return new VirtualStackImageLoaderTimeShifted<UnsignedShortType, VolatileUnsignedShortType, VolatileShortArray>(
                imp, new VirtualStackVolatileShortArrayLoader( imp ), new UnsignedShortType(), new VolatileUnsignedShortType(), timeShift )
        {
            @Override
    ...
    public static VirtualStackImageLoaderTimeShifted< UnsignedByteType, VolatileUnsignedByteType, VolatileByteArray > createUnsignedByteInstance( final ImagePlus imp, int timeShift )
    {
        return new VirtualStackImageLoaderTimeShifted<UnsignedByteType, VolatileUnsignedByteType, VolatileByteArray>(
                imp, new VirtualStackVolatileByteArrayLoader( imp ), new UnsignedByteType(), new VolatileUnsignedByteType(), timeShift )
        {
            @Override
    ...
    public static VirtualStackImageLoaderTimeShifted< ARGBType, VolatileARGBType, VolatileIntArray > createARGBInstance( final ImagePlus imp, int timeShift )
    {
        return new VirtualStackImageLoaderTimeShifted< ARGBType, VolatileARGBType, VolatileIntArray >(
                imp, new VirtualStackVolatileARGBArrayLoader( imp ), new ARGBType(), new VolatileARGBType(), timeShift )
        {
            @Override
    ...
    protected VirtualStackImageLoaderTimeShifted( final ImagePlus imp, final CacheArrayLoader< A > loader, final T type, final V volatileType, int timeShift  )
    {
        this.loader = loader;
        ...
        for ( int setupId = 0; setupId < numSetups; ++setupId )
            setupImgLoaders.add( new SetupImgLoader( setupId, type, volatileType, timeShift ) );
    }
    ...
    public class SetupImgLoader extends AbstractViewerSetupImgLoader< T, V >
    {
        ...
        protected SetupImgLoader( final int setupId, final T type, final V volatileType, int timeShift )
        {
        ...
        {
            return prepareCachedImage( timepointId-timeShift, level, LoadingStrategy.BUDGETED, volatileType );
        }

        @Override
        public RandomAccessibleInterval< T > getImage( final int timepointId, final int level, final ImgLoaderHint... hints )
        {
            return prepareCachedImage( timepointId-timeShift, level, LoadingStrategy.BLOCKING, type );
        }
