...
public class NativeRealPoint3D extends AbstractEuclideanSpace implements RealPositionable, RealLocalizable, NativeType<NativeRealPoint3D> {
    ...
    final NativeTypeFactory<NativeRealPoint3D, FloatAccess> typeFactory;
    ...
    public NativeRealPoint3D() {
        ...
        typeFactory = NativeTypeFactory.FLOAT( (a) -> new NativeRealPoint3D(a) );
    }
    ...
    public NativeRealPoint3D(NativeImg<?,? extends FloatAccess> a) {
        ...
        i = new Index();
        img = a;
        typeFactory = NativeTypeFactory.FLOAT( (access) -> new NativeRealPoint3D(access) );
    }
    ...
    public double getDoublePosition(int d) {
        return dataAccess.getValue( i.get() * 3 + d );
    }
    ...
    public void set(NativeRealPoint3D c) {
        int offsetTarget = i.get()*3;
        int offsetSource = c.i.get()*3;
    ...
    public void move(NativeRealPoint3D point) {
        int offsetTarget = i.get()*3;
        int offsetSource = point.i.get()*3;
    ...
    public void setPosition(int position, int d) {
        dataAccess.setValue(i.get()*3+d, position);
    }
